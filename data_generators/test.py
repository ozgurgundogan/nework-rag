...
def generate_person(id, all_people):
    ...
    classmates = generate_classmate_relationship(person=None, all_people=all_people)
    colleagues = generate_colleague_relationship(person=None, all_people=all_people)
